define(["browser/avalon.browser", "text!./avalon.uploader.html", "../mkoaAjax/mkoaAjax", "./swfobject/swfobject"], function(avalon, sourceHTML,$a){
	...
	var widget = avalon.ui.uploader = function(element, data, vmodels){
		...
		function loadFlash(){
			...
			avalon.swfobject.embedSWF(
				"avalon/uploader/swfobject/multiPicUpload.swf",
